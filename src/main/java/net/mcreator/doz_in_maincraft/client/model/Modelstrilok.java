...
public class Modelstrilok<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("doz_in_maincraft", "modelstrilok"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r9 = bone.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(173, 209).addBox(-0.9F, -1.0704F, -1.0F, 3.275F, 1.3F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.375F, -4.375F, 0.0F, 0.0F, 0.0F, -0.3971F));
		PartDefinition cube_r10 = bone.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(173, 209).addBox(-0.7F, -0.5F, -1.0F, 1.375F, 0.475F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.625F, -3.6F, 0.0F, 0.0F, 0.0F, -0.4145F));
		PartDefinition cube_r11 = bone.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(173, 209).addBox(-0.9F, -0.825F, -0.8F, 2.375F, 1.425F, 1.6F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.5F, -6.1F, 0.0F, 0.0F, 0.0F, 1.0952F));
		PartDefinition cube_r12 = bone.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(173, 209).addBox(0.55F, -0.6F, -0.6F, 0.825F, 0.175F, 1.1F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.65F, -5.375F, 0.0F, 0.0F, 0.0F, -2.3736F));
		PartDefinition cube_r13 = bone.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(173, 209).addBox(0.65F, 0.325F, -0.6F, 0.725F, 0.15F, 1.1F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.65F, -5.375F, 0.0F, 0.0F, 0.0F, -0.5672F));
		PartDefinition cube_r14 = bone.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(173, 209).addBox(-0.875F, -1.125F, -1.0F, 2.4F, 0.7F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r15 = RightArm.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(37, 233).addBox(5.05F, -8.1F, 2.0F, 1.375F, 6.6F, 0.2F, new CubeDeformation(0.0F)).texOffs(19, 232)
		...
		PartDefinition cube_r16 = RightArm.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(199, 196).addBox(6.65F, -7.6F, -1.5F, 0.1F, 0.5F, 0.5F, new CubeDeformation(0.0F)).texOffs(199, 196)
		...
		PartDefinition cube_r17 = RightArm.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(239, 228).addBox(5.525F, -4.6F, -1.5F, 0.5F, 1.7F, 0.5F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, 12.0F, -2.4F, 3.1416F, 0.0F, 2.7751F));
		PartDefinition cube_r18 = RightArm.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(199, 196).addBox(6.65F, -7.6F, -1.5F, 0.1F, 0.5F, 0.5F, new CubeDeformation(0.0F)).texOffs(199, 196)
		...
		PartDefinition cube_r19 = RightArm.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(237, 198).addBox(5.525F, -4.6F, -1.5F, 0.5F, 1.7F, 0.5F, new CubeDeformation(0.0F)),
