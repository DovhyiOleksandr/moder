...
public class Modellesovik3<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("doz_in_maincraft", "modellesovik_3"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 25).addBox(-4.0F, -6.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(54, 53).addBox(0.25F, -5.5F, -2.15F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(54, 41)
						...
						.addBox(0.25F, -4.5F, -2.5F, 3.0F, 0.5F, 0.5F, new CubeDeformation(0.0F)).texOffs(20, 27).addBox(0.25F, -5.5F, -2.5F, 4.0F, 0.5F, 0.5F, new CubeDeformation(0.0F)).texOffs(42, 32)
						...
						.addBox(-2.75F, -4.0F, 1.0F, 5.5F, 0.5F, 1.5F, new CubeDeformation(0.0F)).texOffs(24, 0).addBox(-6.25F, -6.5F, -2.0F, 12.5F, 0.5F, 4.0F, new CubeDeformation(0.0F)),
