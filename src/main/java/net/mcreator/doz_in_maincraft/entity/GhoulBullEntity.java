...
public class GhoulBullEntity extends Monster implements RangedAttackMob {
	public GhoulBullEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DozInMaincraftModEntities.GHOUL_BULL.get(), world);
	}
