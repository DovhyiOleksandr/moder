...
public class BloodyClawEntity extends Zombie {
	public BloodyClawEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DozInMaincraftModEntities.BLOODY_CLAW.get(), world);
	}
