...
public class ObjectDiodeEntity extends Zombie {
	...
	public ObjectDiodeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DozInMaincraftModEntities.OBJECT_DIODE.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(DozInMaincraftModItems.STABILIZER_DIODE.get()));
	}
