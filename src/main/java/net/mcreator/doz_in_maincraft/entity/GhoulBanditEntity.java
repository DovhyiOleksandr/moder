...
public class GhoulBanditEntity extends Monster {
	public GhoulBanditEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DozInMaincraftModEntities.GHOUL_BANDIT.get(), world);
	}
