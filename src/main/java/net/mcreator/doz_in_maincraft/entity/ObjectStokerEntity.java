...
public class ObjectStokerEntity extends Zombie {
	...
	public ObjectStokerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DozInMaincraftModEntities.OBJECT_STOKER.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(DozInMaincraftModItems.STABILIZER_STOKER.get()));
	}
