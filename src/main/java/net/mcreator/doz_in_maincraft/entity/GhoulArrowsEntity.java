...
public class GhoulArrowsEntity extends Monster implements RangedAttackMob {
	public GhoulArrowsEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DozInMaincraftModEntities.GHOUL_ARROWS.get(), world);
	}
