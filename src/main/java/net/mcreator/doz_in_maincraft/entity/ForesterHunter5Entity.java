...
public class ForesterHunter5Entity extends Villager {
	public ForesterHunter5Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(DozInMaincraftModEntities.FORESTER_HUNTER_5.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(DozInMaincraftModEntities.FORESTER_HUNTER_5.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
