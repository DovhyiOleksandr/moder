...
public class RisingExecutionerEntity extends Zombie {
	private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.RED, ServerBossEvent.BossBarOverlay.PROGRESS);

	public RisingExecutionerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DozInMaincraftModEntities.RISING_EXECUTIONER.get(), world);
	}
