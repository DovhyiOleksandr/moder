...
public class ArcFurnace1CRProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((new Object() {
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 4)).getItem() == DozInMaincraftModItems.STEAL_INGOT.get() && new Object() {
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 4)).getItem() == Blocks.AIR.asItem()) {
			{
				...
				if (_ent != null) {
					final int _slotid = 4;
					final ItemStack _setstack = new ItemStack(DozInMaincraftModItems.STEAL_INGOT.get());
