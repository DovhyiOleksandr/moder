...
public class Craft11Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((new Object() {
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 5)).getItem() == DozInMaincraftModItems.TT_SIMBIOT.get() && new Object() {
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 5)).getItem() == Blocks.AIR.asItem()) {
			{
				...
				if (_ent != null) {
					final int _slotid = 5;
					final ItemStack _setstack = new ItemStack(DozInMaincraftModItems.TT_SIMBIOT.get());
