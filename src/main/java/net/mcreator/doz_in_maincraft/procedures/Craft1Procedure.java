...
public class Craft1Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((new Object() {
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 3)).getItem() == DozInMaincraftModItems.UNFINISHED_STIMULANT.get() && new Object() {
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 3)).getItem() == Blocks.AIR.asItem()) {
			{
				...
				if (_ent != null) {
					final int _slotid = 3;
					final ItemStack _setstack = new ItemStack(DozInMaincraftModItems.UNFINISHED_STIMULANT.get());
