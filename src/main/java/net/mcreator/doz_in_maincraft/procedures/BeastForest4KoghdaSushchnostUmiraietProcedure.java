...
public class BeastForest4KoghdaSushchnostUmiraietProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (world instanceof ServerLevel _level) {
			Entity entityToSpawn = new BeastForest3Entity(DozInMaincraftModEntities.BEAST_FOREST_3.get(), _level);
