...
import net.mcreator.doz_in_maincraft.procedures.GasMaskCrahetSobytiieTaktovShliemaProcedure;
...
public abstract class GasMaskCrahetItem extends ArmorItem {
	...
	public static class Helmet extends GasMaskCrahetItem {
		public Helmet() {
			...
			consumer.accept(new IClientItemExtensions() {
				...
				public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("head", new Modelprotgas1(Minecraft.getInstance().getEntityModels().bakeLayer(Modelprotgas1.LAYER_LOCATION)).head, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "body",
