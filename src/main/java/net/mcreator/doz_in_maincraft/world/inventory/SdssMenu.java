...
public class SdssMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SdssMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(DozInMaincraftModMenus.SDSS.get(), id);
