...
public class Modelgul3<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "gul3"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = RightArm.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(2, 57)
						.addBox(-8.9F, -17.2F, -10.6F, 1.7F, 1.2F, 4.4F, new CubeDeformation(0.0F)).texOffs(32, 56)
						.addBox(-8.8F, -16.0F, -8.3F, 1.5F, 0.6F, 1.5F, new CubeDeformation(0.0F)).texOffs(35, 62)
						.addBox(-8.8F, -17.1F, -6.2F, 1.5F, 1.0F, 0.4F, new CubeDeformation(0.0F)).texOffs(19, 57)
						.addBox(-8.25F, -17.3F, -18.0F, 0.4F, 0.4F, 1.6F, new CubeDeformation(0.0F)).texOffs(17, 57)
						.addBox(-8.35F, -17.4F, -18.5F, 0.6F, 0.6F, 0.7F, new CubeDeformation(0.0F)).texOffs(6, 61)
						.addBox(-8.9F, -16.0F, -10.15F, 1.7F, 0.6F, 0.5F, new CubeDeformation(0.0F)).texOffs(11, 51)
						.addBox(-8.75F, -16.4F, -17.75F, 1.4F, 1.4F, 7.125F, new CubeDeformation(0.0F)).texOffs(17, 57)
						.addBox(-8.95F, -16.6F, -17.75F, 1.8F, 1.8F, 0.925F, new CubeDeformation(0.0F)).texOffs(17, 57)
						.addBox(-8.85F, -16.5F, -16.85F, 1.6F, 1.6F, 0.425F, new CubeDeformation(0.0F)).texOffs(5, 60)
						.addBox(-8.9F, -17.2F, -12.7F, 1.7F, 0.8F, 2.1F, new CubeDeformation(0.0F)).texOffs(2, 57)
						.addBox(-8.7F, -17.9F, -17.4F, 1.2F, 0.9F, 4.7F, new CubeDeformation(0.0F)).texOffs(3, 58)
						.addBox(-8.9F, -17.0F, -16.4F, 1.7F, 0.4F, 3.7F, new CubeDeformation(0.0F)).texOffs(2, 57)
						.addBox(-8.5F, -18.1F, -17.4F, 0.8F, 0.2F, 4.7F, new CubeDeformation(0.0F)).texOffs(0, 55)
						.addBox(-8.7F, -17.4F, -12.7F, 1.3F, 0.2F, 6.4F, new CubeDeformation(0.0F)).texOffs(1, 56)
						.addBox(-8.6F, -17.6F, -12.3F, 1.1F, 0.2F, 5.9F, new CubeDeformation(0.0F)).texOffs(1, 56)
						.addBox(-8.5F, -17.8F, -12.3F, 0.9F, 0.2F, 5.8F, new CubeDeformation(0.0F)).texOffs(1, 56)
						.addBox(-8.4F, -18.0F, -12.3F, 0.7F, 0.2F, 5.7F, new CubeDeformation(0.0F)).texOffs(1, 56)
						.addBox(-8.3F, -18.05F, -12.3F, 0.5F, 0.05F, 5.55F, new CubeDeformation(0.0F)).texOffs(6, 61)
						.addBox(-8.7F, -18.1F, -12.7F, 1.3F, 0.7F, 0.4F, new CubeDeformation(0.0F)).texOffs(6, 61)
						.addBox(-8.3F, -18.3F, -13.3F, 0.5F, 0.2F, 1.1F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.3F, 13.9F, 1.0F));

		PartDefinition cube_r2 = bone.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(34, 58)
						.addBox(-0.8F, 7.025F, -17.625F, 1.5F, 0.825F, 0.1F, new CubeDeformation(0.0F)).texOffs(33, 57)
						.addBox(-0.8F, 8.025F, -17.925F, 1.5F, 0.125F, 0.3F, new CubeDeformation(0.0F)).texOffs(24, 51)
						.addBox(-0.7F, 6.925F, -20.625F, 1.3F, 1.1F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.0F, 0.0F, 7.0F, -1.1781F, 0.0F, 0.0F));

		PartDefinition cube_r3 = bone.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(6, 61)
						.addBox(-0.4F, -5.7F, -28.55F, 0.7F, 1.2F, 0.5F, new CubeDeformation(0.0F)).texOffs(6, 61)
						.addBox(-0.6F, -7.3F, -22.75F, 1.0F, 1.2F, 0.5F, new CubeDeformation(0.0F)),
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(49, 53)
				.addBox(-4.075F, -8.525F, -4.325F, 8.175F, 2.0F, 8.6F, new CubeDeformation(0.0F)).texOffs(48, 52)
				.addBox(-4.35F, -6.9F, -4.675F, 8.775F, 0.575F, 9.35F, new CubeDeformation(0.0F)).texOffs(0, 0)
